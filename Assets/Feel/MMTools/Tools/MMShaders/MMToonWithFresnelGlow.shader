Shader "MoreMountains/MMToonFresnel"
{
    Properties
    {
    ...
    SubShader
    {
                                                    ...
                                                    UnityGI gi)
        {
            ...
            // Fresnel Inner Glow
            float fresnelTerm = 1.0 - dot(ase_worldViewDir, ase_worldNormal);
            c.rgb += _FresnelColor.rgb * pow(fresnelTerm, _FresnelPower) * _Fresnel;
